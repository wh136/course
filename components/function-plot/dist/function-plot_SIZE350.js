(function (f) {
    ...
    return function e(t, n, r) {
        ...
        3: [function (require, module, exports) {
            ...
            var evalTypeFn = {interval: require("./samplers/interval"), builtIn: require("./samplers/builtIn")};
        ...
        4: [function (require, module, exports) {
            ...
            var Globals = {
                COLORS: ["steelblue", "red", "#05b378", "orange", "#4040e8", "yellow", "brown", "magenta", "cyan"].map(function (v) {
                    return d3.hsl(v)
                }), DEFAULT_WIDTH: 450, DEFAULT_HEIGHT: 550, TIP_X_EPS: 1
            };
        ...
        10: [function (require, module, exports) {
            ...
            module.exports = function (chart) {
                var derivativeDatum = datumDefaults({skipTip: true, nSamples: 2, graphType: "polyline"});
                var derivative;
        ...
        11: [function (require, module, exports) {
            "use strict";
            var samplers = {interval: require("interval-arithmetic-eval"), builtIn: require("built-in-math-eval")};
        ...
        13: [function (require, module, exports) {
            ...
            var polyline = require("../graph-types/polyline");
            module.exports = function (chart) {
                var secantDefaults = datumDefaults({isHelper: true, skipTip: true, nSamples: 2, graphType: "polyline"});
                var secant;
        ...
        }, {"../datum-defaults": 2, "../graph-types/polyline": 7, "./eval": 11, extend: 32}],
                ...
                Chart.prototype.setUpEventListeners = function () {
                    ...
                    var all = {
                        mousemove: function () {
                            ...
                            var coordinates = {x: xScale.invert(mouse[0]), y: yScale.invert(mouse[1])};
        ...
        }, {extend: 32, "integrate-adaptive-simpson": 35, "key-pressed": 54, keydown: 55}],
        16: [function (require, module, exports) {
            module.exports = {zoomBox: require("./zoom-box"), definiteIntegral: require("./definite-integral")}
        ...
        19: [function (require, module, exports) {
            ...
            var sampler = function (chart, d, range, nSamples) {
                var fnTypes = {parametric: parametric, polar: polar, points: points, vector: vector, linear: linear};
        ...
        20: [function (require, module, exports) {
            ...
            module.exports = sampler
        }, {"../helpers/eval": 11, "../utils": 22, "interval-arithmetic-eval": 36}],
        21: [function (require, module, exports) {
            ...
            module.exports = function (config) {
                config = extend({
                    xLine: false, yLine: false, renderer: function (x, y, index) {
                        return "(" + x.toFixed(3) + ", " + y.toFixed(3) + ")"
                    }, owner: null
                }, config);
                var MARGIN = 20;
        ...
        }, {"./globals": 4, "./helpers/eval": 11, "./utils": 22, clamp: 29, extend: 32}],
        ...
        28: [function (require, module, exports) {
            ...
            module.exports = function (expression) {
                return (new CodeGenerator).setDefs({$$processScope: processScope}).parse(expression).compile(math)
            };
        ...
        34: [function (require, module, exports) {
            module.exports = function () {
                var from = 0, to = 0, every = 1, output = [];
                switch (arguments.length) {
                    case 1:
                        to = arguments[0];
                        break;
        ...
        38: [function (require, module, exports) {
            ...
            module.exports = function (expression) {
                return (new CodeGenerator).setDefs({$$processScope: processScope}).parse(expression).compile(Interval)
            };
            module.exports.policies = require("./policies")(Interval);
            module.exports.Interval = Interval
        }, {"./adapter": 37, "./policies": 39, "interval-arithmetic": 40, "math-codegen": 59}],
        ...
        }, {"../constants": 41, "../interval": 42, "../round-math": 51, "./division": 45, "./utils": 49}],
        ...
        }, {"../constants": 41, "../interval": 42, "../round-math": 51, "./utils": 49}],
        46: [function (require, module, exports) {
            ...
            module.exports = misc
        }, {"../constants": 41, "../interval": 42, "../round-math": 51, "./arithmetic": 44, "./utils": 49}],
        ...
        56: [function (require, module, exports) {
            ...
            module.exports = function linspace(a, b, n) {
                var every = (b - a) / (n - 1), ranged = integers(a, b, every);
        ...
        63: [function (require, module, exports) {
            "use strict";
            module.exports = {"+": "positive", "-": "negative", "~": "oneComplement"}
        }, {}],
        ...
        71: [function (require, module, exports) {
            ...
            module.exports = function (node) {
                ...
                return this.FunctionNode({name: namedOperator, args: [node.argument]})
            }
            ...
            Lexer.prototype.lex = function (text) {
                ...
                while (this.index < this.text.length) {
                    ...
                    if (isDelimiter(c3)) {
                        ...
                        this.tokens.push({type: tokenType.NUMBER, value: this.readNumber()})
                    } else if (isQuote(c)) {
                        this.tokens.push({type: tokenType.STRING, value: this.readString()})
                    } else if (isIdentifier(c)) {
                        this.tokens.push({type: tokenType.SYMBOL, value: this.readIdentifier()})
                    } else {
        ...
        87: [function (require, module, exports) {
            module.exports = {EOF: 0, DELIMITER: 1, NUMBER: 2, STRING: 3, SYMBOL: 4}
        }, {}],
        ...
        90: [function (require, module, exports) {
            var ua = typeof window !== "undefined" ? window.navigator.userAgent : "", isOSX = /OS X/.test(ua),
                isOpera = /Opera/.test(ua), maybeFirefox = !/like Gecko/.test(ua) && !isOpera;
